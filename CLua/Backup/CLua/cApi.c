...
//编译命令行: gcc -g cApi.c -o cApi -lm /home/lzg/trunk/3rd/lua/lua-5.1.4_coco-1.1.5/src/liblua.a
//编译命令行: gcc -g cApi.c -o cApi -lm -L/home/lzg/trunk/3rd/lua/lua-5.1.4_coco-1.1.5/src -llua
