...
foo.current = 'running';
console.log('foo.counter:', foo.counter, 8, 'set state by force will not increase counter');
...
console.log('foo.counter:', foo.counter, 11, 'incremented counter during onenterrunning');
