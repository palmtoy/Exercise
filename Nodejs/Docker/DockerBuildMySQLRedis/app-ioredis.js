...
const redisCli = new Redis.Cluster(dbOptions.redis.nodes, dbOptions.redis.options);
...
const server = http.createServer((req, res) => {
	...
	.finally(() => {
		redisCli.setex('foo', 600, 'bar');
		redisCli.setex('hello', 600, 'world');
		redisCli.setex('hi', 600, 'baby');
